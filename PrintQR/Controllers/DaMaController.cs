...
namespace 打码器.Controllers
{
    public class PrintQRController : ApiController
    {
        ...
        private static string GetMysqlConnStr()
        {
            string connStr = WebConfigurationManager.AppSettings["ConnectionStringjf"].ToString();
